...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `scene_00_intro_entry` | `chapter_00_intro` | `segment_00_invocation` | 入口声明容器 | `B_composite_teaching_scene` | `TBD_CASE_ANCHOR_INTRO_01` | `E2_unresolved` | `SRC_TBD_INTRO_01` | `contextual_atmosphere` | `video` | `D_static_minimum` | `video_first_review` | `draft` | 只负责真实性与观看入口 |
| `scene_01_orientation_order` | `chapter_01_orientation` | `segment_01_order_entry` | 定向与秩序容器 | `B_composite_teaching_scene` | `TBD_CASE_ANCHOR_ORIENTATION_01` | `E2_unresolved` | `SRC_TBD_ORDER_01` | `supporting_transition` | `video` | `C_low_bandwidth` | `video_first_review` | `draft` | 不承担结构高潮 |
...
| `scene_03_structure_primary` | `chapter_03_structure` | `segment_02_structural_climax` | 结构高潮主容器 | `C_abstract_explanatory_layer` | `TBD_CASE_ANCHOR_STRUCTURE_01` | `E2_unresolved` | `SRC_TBD_STRUCTURE_01` | `primary_explanation` | `2.5D` | `D_static_minimum` | `video_first_review` | `draft` | 不得仅靠视频解释 |
...
| `scene_06_conservation_boundary` | `chapter_05_conservation` | `segment_03_return_to_detail_and_care` | 保护边界容器 | `B_composite_teaching_scene` | `TBD_CASE_ANCHOR_CONSERVATION_01` | `E2_unresolved` | `SRC_TBD_CONSERVATION_01` | `evidence_reference` | `vector_programmatic` | `D_static_minimum` | `video_first_review` | `draft` | 视频不是主承载 |
